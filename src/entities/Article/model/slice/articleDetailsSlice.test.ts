...
import { ArticleBlockTypes, ArticleDetailsSchema, ArticleTypes } from '../types/article';
...
describe('articleDetailsSlice.test', () => {
    ...
    test('fetchArticleById.pending', () => {
        expect(articleDetailsReducer(state, fetchArticleById.pending))
            .toEqual({
                ...state,
                isLoading: true,
            });
    ...
    test('fetchArticleById.rejected', () => {
        expect(articleDetailsReducer(state, {
