...
describe('loginSlice', () => {
    ...
    test('setUsername', () => {
        expect(
            authByUsernameReducer(loginState, authByUsernameActions.setUsername('Some username')),
    ...
    test('setPassword', () => {
        expect(
            authByUsernameReducer(loginState, authByUsernameActions.setPassword('Some password')),
        ).toEqual<AuthByUsernameSchema>({
            username: '',
    ...
    test('setLoading', () => {
        ...
        expect(authByUsernameReducer(loginState, action)).toEqual<AuthByUsernameSchema>({
            username: '',
            password: '',
            isLoading: true,
        });
