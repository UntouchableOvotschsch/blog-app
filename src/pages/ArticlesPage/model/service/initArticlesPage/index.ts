...
export const initArticlesPage = createAsyncThunk<void, URLSearchParams, ThunkConfigType<string>>(
    ...
    async (searchParams, thunkAPI) => {
        ...
        const localStorageView =
            (localStorage.getItem(ARTICLE_VIEW_KEY) as ArticleViewTypes) || ArticleViewTypes.SMALL_TILE;
